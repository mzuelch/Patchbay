...
# Mark run-tab workflow layout as dirty so its content gets re-centered
    ...
    def build(self) -> None:
        ...
        with dpg.window(
            ...
            with dpg.child_window(
                ...
                # NOTE: Some DearPyGui builds do not expose mvTabBarFittingPolicy_* enums.
                # The default behaviour already keeps tabs left-aligned and compact.
                with dpg.tab_bar():
    ...
    def _build_marker_controls(self) -> None:
        dpg = self.dpg
        with dpg.group(horizontal=True):
